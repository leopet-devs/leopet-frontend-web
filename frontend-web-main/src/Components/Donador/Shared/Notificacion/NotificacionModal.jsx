  ...
  return (
    <div className="notificacion-dialog ">
      <div className="notificacion-content noti-card">
        <div className="fund-txt-24 fund-mb-16">Notificaciones</div>
        <div className="noti-don-animals-content">
          <div className="fund-txt-24 fund-mb-16"></div>
                    ...
                    <div className="noti-data-animal noti-animal-row">
                      <div className="noti-column">
                        <img
                          ...
                          src={
                            notificacion.animal.especie.toLowerCase() ===
                            "perro"
                              ? imgPerro
                              : imgGato
                          }
                      ...
                      <div className="noti-txt-10-green noti-animal-column">
                        {notificacion.animal.nombre}{" "}
                      </div>
                    </div>
                    <div className="noti-column">
                      <div className="noti-txt-8 noti-animal-column">
                        Fundación{" "}
                        {notificacion.actualizacion.fundacion.length <= 17
                          ? notificacion.actualizacion.fundacion
                          : `${notificacion.actualizacion.fundacion.substring(
                              0,
                              17
                            )}...`}
                      </div>
                    ...
                    <div className="noti-column">
                      <div className="noti-txt-datofun noti-animal-row">
                        {notificacion.actualizacion.descripcion.length <= 28
                          ...
                          : `${notificacion.actualizacion.descripcion.substring(
                              0,
                              28
                            )}...`}
                      </div>
        ...
        <div className="fund-form-buttons">
          <button className="fund-btn" onClick={() => setShowNotificacion()}>
            CERRAR
          </button>
        </div>
      </div>
